...
#include "os_mutex_common.hpp"
#include "os_mutex_api.hpp"
#include "os_mutex_type.hpp"
...
namespace nn::os {
    ...
    class Mutex {
        ...
        private:
            MutexType m_mutex;
        public:
            constexpr explicit Mutex(bool recursive) : m_mutex{::nn::os::MutexType::State_Initialized, recursive, 0, 0, nullptr, { {std::byte(0)} } } { /* ... */ }
            constexpr Mutex() : Mutex(false) { /* ... */ }
