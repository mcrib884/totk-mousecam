...
namespace nn::fs {
    ...
    */
    ...
    /*
        Read file at a location, with an output amount of bytes read and explicit size.
        bytesRead:  How many bytes were actually read.
        handle:     Handle representing file to be read.
        position:   Position within the file to be read.
        ...
        size:       How many bytes to read from file.
    */
    Result ReadFile(ulong* bytesRead, FileHandle handle, long position, void* buffer, ulong size);
